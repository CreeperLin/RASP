...
ops = {
    'avg_pool_3x3':
    lambda C, stride, affine: PoolBN('avg', C, 3, stride, 1, affine=affine),
    'max_pool_3x3':
    lambda C, stride, affine: PoolBN('max', C, 3, stride, 1, affine=affine),
    ...
    'std_conv_3x3':
    lambda C, stride, affine: StdConv(C, C, 3, stride, 1, affine=affine),
    'std_conv_5x5':
    lambda C, stride, affine: StdConv(C, C, 5, stride, 2, affine=affine),
    'std_conv_7x7':
    lambda C, stride, affine: StdConv(C, C, 7, stride, 3, affine=affine),
    'dil_conv_3x3':
    ...
    'conv_7x1_1x7':
    lambda C, stride, affine: FacConv(C, C, 7, stride, 3, affine=affine),
    'conv_1x1':
    lambda C, stride, affine: StdConv(C, C, 1, stride, 0, affine=affine)
}
