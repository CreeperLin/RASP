...
class RegressorDevice():
    ...
    def run(df=None, X_col=None, y_col=None, X_filter=None, y_filter=None):
        ...
        df = report(RegressorDevice.tape, include_root=False, report_fields=fields) if df is None else df
...
def get_data(X_col, y_col, fields):
    ...
    return report(RegressorDevice.tape, include_root=False, report_fields=fields)
